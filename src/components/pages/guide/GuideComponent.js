                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide2Img} alt="" className="img-fluid" />
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide3Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide4Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide5Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide6Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide7Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide8Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide9Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide10Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide11Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="guide-card">
                                <div className="guide-thumb">
                                    <img   loading="lazy" src={guide12Img} alt="" className="img-fluid" />
                                    <div className="guide-info">
                                        <strong>Sakura Chen</strong>
                                        <p>Tour Guide</p>
                                        <ul className="guide-links">
