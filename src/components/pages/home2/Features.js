                   ...
                   <OwlCarousel className="feature-slider-2 owl-carousel"  {...featuresOptions}>
                       <div className="feature-card-2">
                           <div className="feature-thumb">
                               <img   loading="lazy" src={features1Img} alt="" className="img-fluid" />
                           ...
                           <div className="feature-card-review">
                               ...
                               <Link to={"/package-details"} className="feature-btn">Book Now</Link>
                           </div>
                       </div>
                       <div className="feature-card-2">
                           <div className="feature-thumb">
                               <img   loading="lazy" src={features2Img} alt="" className="img-fluid" />
                               <div className="feature-price">
                                   <h5>$110 <span>/ Couple</span></h5>
                               </div>
                           </div>
