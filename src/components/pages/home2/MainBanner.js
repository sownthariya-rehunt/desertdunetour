                ...
                <div className="container">
                    ...
                    <OwlCarousel className="offer-slider dark-nav owl-carousel"  {...mainBannerOptions}>
                        <div className="offer-card">
                            <div className="offer-thumb">
                                <Link to={"/package-details"}>
                                    <img   loading="lazy" src={offer1Image} alt="" className="img-fluid" />
                                </Link>
                            </div>
                        ...
                        <div className="offer-card">
                            <div className="offer-thumb">
                                <Link to={"/package-details"}>
                                    <img   loading="lazy" src={offer2Image} alt="" className="img-fluid" />
                                </Link>
                            </div>
                            <div className="offer-details">
                                <div className="offer-info">
                        ...
                        <div className="offer-card">
                            <div className="offer-thumb">
                                <Link to={"/package-details"}>
                                    <img   loading="lazy" src={offer3Image} alt="" className="img-fluid" />
                                </Link>
                            </div>
                            <div className="offer-details">
                                <div className="offer-info">
