               ...
               <div className="container">
                   ...
                   <div className="row">
                       <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInLeft animated" data-wow-duration="1500ms" data-wow-delay="0ms">
                           <div className="blog-card">
                               <div className="blog-img">
                                   <img   loading="lazy" src={blog1Img} alt="" className="img-fluid" />
                               ...
                               <div className="blog-details">
                                   ...
                                   <Link to={"/blog-details"} className="blog-title">Donec egestas orci viverra
                                       fermentum risus.</Link>
                                   <div className="blog-btn">
                                       <Link to={"/blog-details"} className="btn-common-sm">Read More</Link>
                                   </div>
                               </div>
                           </div>
                       </div>
                       <div className="col-lg-4 col-md-6 col-sm-6  wow fadeInLeft animated" data-wow-duration="1500ms" data-wow-delay="300ms">
                           <div className="blog-card">
                               <div className="blog-img">
                                   <img   loading="lazy" src={blog2Img} alt="" className="img-fluid" />
                                   <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                               </div>
                               <div className="blog-details">
                                   <div className="blog-info">
                                   ...
                                   <Link to={'/blog-details'} className="blog-title">Praesent ut mattis ante the Nullam lobortis.</Link>
                                   <div className="blog-btn">
                                       <Link to={'/blog-details'} className="btn-common-sm">Read More</Link>
                                   </div>
                               </div>
                       ...
                       <div className="col-lg-4 col-md-6 col-sm-6 wow fadeInLeft animated" data-wow-duration="1500ms" data-wow-delay="600ms">
                           <div className="blog-card">
                               <div className="blog-img">
                                   <img   loading="lazy" src={blog3Img} alt="" className="img-fluid" />
                                   <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                               </div>
                               <div className="blog-details">
                                   <div className="blog-info">
                                   ...
                                   <Link to={'/blog-details'} className="blog-title">Maecenas vehicula risus non neque tincidunt.</Link>
                                   <div className="blog-btn">
                                       <Link to={'/blog-details'} className="btn-common-sm">Read More</Link>
                                   </div>
                               </div>
