                        ...
                        <div className="col-lg-8">
                            <div className="row">
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_1} alt="" className="img-fluid" />
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_2} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_3} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_4} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_5} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_6} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_7} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_8} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_9} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_10} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_11} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="blog-card">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_12} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                            ...
                                            <ul>
                                                <li className="blog-card-sm">
                                                    <div className="blog-img-sm">
                                                        <img   loading="lazy" src={b_sm_1} alt="" />
                                                    </div>
                                                ...
                                                <li className="blog-card-sm">
                                                    <div className="blog-img-sm">
                                                        <img   loading="lazy" src={b_sm_2} alt="" />
                                                    </div>
                                                    <div className="blog-details-sm">
                                                ...
                                                <li className="blog-card-sm">
                                                    <div className="blog-img-sm">
                                                        <img   loading="lazy" src={b_sm_3} alt="" />
                                                    </div>
                                                    <div className="blog-details-sm">
                                                ...
                                                <li className="blog-card-sm">
                                                    <div className="blog-img-sm">
                                                        <img   loading="lazy" src={b_sm_4} alt="" />
                                                    </div>
                                                    <div className="blog-details-sm">
                                                        <Link to={`${process.env.PUBLIC_URL}/blog-details`} className="blog-title-sm">Lake Garda</Link>
                                                        <div className="blog-info">
                                                ...
                                                <li className="blog-card-sm">
                                                    <div className="blog-img-sm">
                                                        <img   loading="lazy" src={b_sm_5} alt="" />
                                                    </div>
                                                    <div className="blog-details-sm">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12 col-md-6">
                                        <div className="sidebar-banner mt-40">
                                            <img   loading="lazy" src={sidebarBanner} alt="" className="img-fluid" />
