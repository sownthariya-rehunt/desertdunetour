                        ...
                        <div className="col-lg-8">
                            <div className="blog-details">
                                ...
                                <div className="blog-img-xl">
                                    <img   loading="lazy" src={bd_png} alt="" className="img-fluid" />
                                ...
                                <div className="blog-texts mt-30">
                                    ...
                                    <div className="blog-gallary">
                                        <img   loading="lazy" src={b_g_1} alt="" className="img-fluid" />
                                        <img   loading="lazy" src={b_g_2} alt="" className="img-fluid" />
                                        <img   loading="lazy" src={b_g_3} alt="" className="img-fluid" />
                                    </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div className="commentor">
                                                <div className="commentotor-img"><img   loading="lazy" src={c_1} alt="" /></div>
                                        ...
                                        <li>
                                            <div className="commentor">
                                                <div className="commentotor-img"><img   loading="lazy" src={c_2} alt="" /></div>
                                                <div className="commentor-id">
                                                    <strong>Jonson Hur</strong>
                                                    <p><span>2 April, 2021 </span><span>10.00PM</span></p>
                                                </div>
                                        ...
                                        <li>
                                            <div className="commentor">
                                                <div className="commentotor-img"><img   loading="lazy" src={c_3} alt="" /></div>
                                                <div className="commentor-id">
                                                    <strong>Jonson Hur</strong>
                                                    <p><span>2 April, 2021 </span><span>10.00PM</span></p>
                                                </div>
