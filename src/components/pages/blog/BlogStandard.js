                        ...
                        <div className="col-lg-8 col-md-7">
                            <div className="row">
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="blog-card-xl">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_xl_1} alt="" className="img-fluid" />
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="blog-card-xl">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_xl_2} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="blog-card-xl">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_xl_3} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="blog-card-xl">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_xl_4} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
                                ...
                                <div className="col-lg-12 col-md-12 col-sm-12">
                                    <div className="blog-card-xl">
                                        <div className="blog-img">
                                            <img   loading="lazy" src={b_xl_5} alt="" className="img-fluid" />
                                            <div className="blog-date"><i className="flaticon-calendar" /> 1 April, 2021</div>
                                        </div>
                                        <div className="blog-details">
                                            <div className="blog-info">
