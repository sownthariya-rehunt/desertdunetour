           ...
           <div className="destinations-area pt-120">
               <div className="container">
                   ...
                   <div className="row">
                       <div className="col-lg-3 col-md-3">
                           <div className="package-slider-wrap">
                               <img   loading="lazy" src={destinations1Img} alt="" className="img-fluid" />
                       ...
                       <div className="col-lg-9 col-md-9">
                           <OwlCarousel className="row owl-carousel destinations-1"  {...destinationsOptions}>
                               <div className="package-card">
                                   <div className="package-thumb">
                                       <Link to={"/package-details"}>
                                           <img   loading="lazy" src={destinations4Img} alt="" className="img-fluid" />
                                       </Link>
                                   </div>
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link to={"/package-details"}>Paris Hill Tour</Link>
                                       </h3>
                               ...
                               <div className="package-card">
                                   <div className="package-thumb">
                                       <Link to={"/package-details"}>
                                           <img   loading="lazy" src={destinations5Img} alt="" className="img-fluid" />
                                       </Link>
                                   </div>
                                   <div className="package-details">
                                       <div className="package-info">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link to={"/package-details"}>Lake Garda, Spain</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   <div className="package-thumb">
                                       <Link to={"/package-details"}>
                                           <img   loading="lazy" src={destinations6Img} alt="" className="img-fluid" />
                                       </Link>
                                   </div>
                                   <div className="package-details">
                                       <div className="package-info">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link to={"/package-details"}>Mount Dtna, Spain</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   <div className="package-thumb">
                                       <Link to={"/package-details"}>
                                           <img   loading="lazy" src={destinations7Img} alt="" className="img-fluid" />
                                       </Link>
                                   </div>
                                   <div className="package-details">
                                       <div className="package-info">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link to={"/package-details"}>Amalfi Costa, Italy</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                   ...
                   <div className="row">
                       <div className="col-lg-9 col-md-9">
                           <OwlCarousel className="row owl-carousel destinations-2"  {...destinationsOptions}>
                               ...
                               <div className="package-card">
                                   <div className="package-thumb">
                                       <Link to={"/package-details"}>
                                           <img   loading="lazy" src={destinations8Img} alt="" className="img-fluid" />
                                       </Link>
                                   </div>
                                   <div className="package-details">
                                       <div className="package-info">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link to={"/package-details"}>Fench Rivira, Italy</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   <div className="package-thumb">
                                       <Link to={"/package-details"}>
                                           <img   loading="lazy" src={destinations9Img} alt="" className="img-fluid" />
                                       </Link>
                                   </div>
                                   <div className="package-details">
                                       <div className="package-info">
                               ...
                               <div className="package-card">
                                   <div className="package-thumb">
                                       <Link to={"/package-details "}>
                                           <img   loading="lazy" src={destinations10Img} alt="" className="img-fluid" />
                                       </Link>
                                   </div>
                                   <div className="package-details">
                                       <div className="package-info">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link to={'/package-details'}>Mount Dtna, Italyr</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                       ...
                       <div className="col-lg-3 col-md-3">
                           <div className="package-slider-wrap">
                               <img   loading="lazy" src={destinations2Img} alt="" className="img-fluid" />
                               <div className="pakage-overlay">
                                   <strong>Italy</strong>
                               </div>
                           </div>
                   ...
                   <div className="row">
                       <div className="col-lg-3 col-md-3">
                           <div className="package-slider-wrap">
                               <img   loading="lazy" src={destinations3Img} alt="" className="img-fluid" />
                               <div className="pakage-overlay">
                                   <strong>Dubai</strong>
                               </div>
                           </div>
                       ...
                       <div className="col-lg-9 col-md-9">
                           <OwlCarousel className="row owl-carousel destinations-1"  {...destinationsOptions}>
                               <div className="package-card">
                                   <div className="package-thumb">
                                       <Link to={'/package-details'}>
                                           <img   loading="lazy" src={destinations11Img} alt="" className="img-fluid" />
                                       </Link>
                                   </div>
                                   <div className="package-details">
                                       <div className="package-info">
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link to={'/package-details'}>Maritime Heritage</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3><i className="flaticon-arrival" />
                                           <Link to={'/package-details'}>Souks of Deira</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
                               ...
                               <div className="package-card">
                                   ...
                                   <div className="package-details">
                                       ...
                                       <h3>
                                           ...
                                           <Link to={'/package-details'}>Jumeirah Mosque</Link>
                                       </h3>
                                       <div className="package-rating">
                                           <i className="bx bxs-star" />
                                           <strong><span>1.3K+</span> Rating</strong>
