...
import pd_thumb from "../../../assets/image_desert/Quad Bike Pictures.png"
import pd_thumb1 from "../../../assets/image_desert/Quad Bike Pictures.png"
import pd_thumb2 from "../../../assets/image_desert/Quad Bike Pictures.png"
import pd_thumb3 from "../../../assets/image_desert/Quad Bike Pictures.png"
...
class AbudhabiDetails extends Component {
    constructor(props) {
        super(props);
        this.state = {
            startDate: new Date(),
                            ...
                            <div className="package-details">
                                ...
                                <div className="package-header">
                                    <div className="package-title">
                                        ...
                                        Private Car: AED 2100 (Up to 4 Persons)
                                        </strong>
                                    </div>
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="tab-content-1">
                                                        <div className="p-overview">
                                                            <h5>Overview</h5>
                                                            <p>Indulge in a romantic evening with a Private Dune Dinner. Enjoy a scenic drive through the dunes, followed by a specially arranged BBQ Dinner setup in the desert. Experience a memorable dining experience under the starlit sky.</p>
                                                        </div>
                                                        <div className="p-highlight">
                                                            <h5>Highlight</h5>
                                                            <ul>
                                                            
                                         <li><i className="bx bx-circle" /> <p>   Private Transfer</p></li>
                                                                <li><i className="bx bx-circle" /> <p>Dune Drive</p></li>
                                                                <li><i className="bx bx-circle" /> <p>Romantic Dune Dinner setup</p></li>
                                                                <li><i className="bx bx-circle" /> <p>BBQ Dinner</p></li>
                                                                <li><i className="bx bx-circle" /> <p>Water/Soft drinks</p></li>
                                                ...
                                                <div className="row">
                                                    <div className="col-lg-12">
                                                        <div className="p-timeline-overview">
                                                            <h5>Overview</h5>
                                                            <p>Experience the stunning Desert Sunrise on this morning adventure. Explore the golden sands with thrilling Dune Bashing and Sand Boarding. Visit a Camel Farm, ride a Camel, and enjoy refreshing Water/Soft Drinks amidst the desert beauty.</p>
                                                        </div>
                                                        ...
                                                        <div className="package-grid-one">
                                                            <div className="single-grid">
                                                                <Link to={gallery1Img} className="g-img-sm-1 main-gallary">
                                                                    <img   loading="lazy" src={gallery1Img} alt="gallary-img" />
                                                                </Link>

                                                                <Link to={gallery2Img} className="g-img-sm-2 main-gallary">
                                                                    <img   loading="lazy" src={gallery2Img} alt="gallary-img" />
                                                                </Link>

                                                                <Link to={galleryGxx1Img} className="g-img-md main-gallary">
                                                                    <img   loading="lazy" src={galleryGxx1Img} alt="gallary-img" />
                                                                </Link>
                                                            </div>
                                                            <div className="single-grid mt-24">
                                                                ...
                                                                <Link to={gallery4Img} className="g-img-sm-2 main-gallary">
                                                                    <img   loading="lazy" src={gallery4Img} alt="gallary-img" />
                                                                </Link>
                                                                <Link to={galleryGxx2Img} className="g-img-md main-gallary">
                                                                    <img   loading="lazy" src={galleryGxx2Img} alt="gallary-img" />
                                                                </Link>
                                                            </div>
                                                            ...
                                                            <div className="single-grid mt-24">
                                                                ...
                                                                <Link to={gallery5Img} className="g-img-sm-1 main-gallary">
                                                                    <img   loading="lazy" src={gallery5Img} alt="gallary-img" />
                                                                </Link>
                                                                {/* <Link to={} className="g-img-sm-2 main-gallary">
                                                                    <img   loading="lazy" src={} alt="gallary-img" />
                                                                </Link> */}
                                                                <Link to={galleryGxx3Img} className="g-img-md main-gallary">
                                                                    <img   loading="lazy" src={galleryGxx3Img} alt="gallary-img" />
                                                                </Link>
                                                            </div>
                                                        ...
                                                        <div className="package-grid-two">
                                                            <div className="single-grid-2">
                                                                <Link to={galleryGxl1Img}  className="main-gallary">
                                                                    <img   loading="lazy" src={galleryGxl1Img} alt="gallary-img" />
                                                                </Link>
                                                            </div>
                                                            <div className="single-grid-2 mt-24">
                                                                <Link to={galleryGxl2Img}  className="single-grid-2 main-gallary mt-30">
                                                                    <img   loading="lazy" src={galleryGxl2Img} alt="gallary-img" />
                                                                </Link>
                                                            </div>
                                                            <div className="single-grid-2 mt-24">
                                                                <Link to={galleryGxl3Img}  className="main-gallary mt-30">
                                                                    <img   loading="lazy" src={galleryGxl3Img} alt="gallary-img" />
                                                                </Link>
                                                            </div>
                        ...
                        <div className="col-lg-12">
                            <div className="package-details">
                                <div className="package-thumb">
                                    <img   loading="lazy" src={pd_thumb} alt="" />
                                </div>
                                <div className="package-header">
                                    <div className="package-title">
...
Child: AED 210 (Min 2 pax)
                                ...
                                <div className="package-tab">
                                    <ul className="nav nav-pills" id="pills-tab" role="tablist">
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home1" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><i className="flaticon-info" />
                                                Information</button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile1" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><i className="flaticon-clipboard" />
                                                Travel Plan</button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact1" type="button" role="tab" aria-controls="pills-contact" aria-selected="false"> <i className="flaticon-gallery" />
                                                Our Gallary</button>
                                        </li>
                                    </ul>
                                    <div className="tab-content p-tab-content" id="pills-tabContent">
                                            ...
                                            <div className="row">
                                                <div className="col-lg-12">
                                                    <div className="tab-content-1">
                                                        <div className="p-overview">
                                                            <h5>Overview</h5>
                                                            <p>Embark on a thrilling morning adventure in the desert from 8:00 am to 12:00 pm. Feel the rush of Dune Bashing and Sand Boarding as you navigate the sandy terrain. Immerse in the local culture with a Camel Farm Visit, Camel Riding, and savor Water/Soft Drinks in this unique experience. Inclusions:</p>
                                                        </div>
                                                        <div className="p-highlight">
                                                            <h5>Highlight</h5>
                                                            <ul>
                                                         
                                         <li><i className="bx bx-circle" /> <p>   Desert Sunrise experience</p></li>
                                                                <li><i className="bx bx-circle" /> <p>Dune Bashing</p></li>
                                                                <li><i className="bx bx-circle" /> <p>Sand Boarding</p></li>
                                                                <li><i className="bx bx-circle" /> <p>Camel Farm Visit</p></li>
                                                                <li><i className="bx bx-circle" /> <p>Camel Riding</p></li>
                                                                <li><i className="bx bx-circle" /> <p>Water/Soft Drinks                                                                 </p></li>
                                                                <p>Indulge in an action-packed morning escapade in the mesmerizing desert landscape.</p>
                                                            </ul>
                                                        </div>
                                                        <div className="p-details-table">
                                                            <table className="table caption-top">
                                        ...
                                        <div className="tab-pane fade" id="pills-contact1" role="tabpanel" aria-labelledby="pills-contact-tab">
                                            <div className="tab-contant-3">
                                                <SRLWrapper>
                                                <div className="row">
                                                    <div className="col-lg-8 col-md-8">
...
Child: AED 210 (Min 2 pax)
                                ...
                                <div className="package-tab">
                                    <ul className="nav nav-pills" id="pills-tab" role="tablist">
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home3" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><i className="flaticon-info" />
                                                Information</button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile3" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><i className="flaticon-clipboard" />
                                                Travel Plan</button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact3" type="button" role="tab" aria-controls="pills-contact" aria-selected="false"> <i className="flaticon-gallery" />
                                                Our Gallary</button>
                                        </li>
                                    </ul>
                                    <div className="tab-content p-tab-content" id="pills-tabContent">
                                        ...
                                        <div className="tab-pane fade" id="pills-contact3" role="tabpanel" aria-labelledby="pills-contact-tab">
                                            <div className="tab-contant-3">
                                                <SRLWrapper>
                                                <div className="row">
                                                    <div className="col-lg-8 col-md-8">
...
Child: AED 210 (Min 2 pax)
                                ...
                                <div className="package-tab">
                                    <ul className="nav nav-pills" id="pills-tab" role="tablist">
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home4" type="button" role="tab" aria-controls="pills-home" aria-selected="true"><i className="flaticon-info" />
                                                Information</button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile4" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><i className="flaticon-clipboard" />
                                                Travel Plan</button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button className="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact4" type="button" role="tab" aria-controls="pills-contact" aria-selected="false"> <i className="flaticon-gallery" />
                                                Our Gallary</button>
                                        </li>
                                    </ul>
                                    <div className="tab-content p-tab-content" id="pills-tabContent">
                                        <div className="tab-pane fade show active" id="pills-home4" role="tabpanel" aria-labelledby="pills-home-tab">
                                            <div className="row">
                                                <div className="col-lg-12">
                                                    <div className="tab-content-1">
                                                        <div className="p-overview">
                                        ...
                                        <div className="tab-pane fade" id="pills-contact4" role="tabpanel" aria-labelledby="pills-contact-tab">
                                            <div className="tab-contant-3">
                                                <SRLWrapper>
                                                <div className="row">
                                                    <div className="col-lg-8 col-md-8">
...
export default  AbudhabiDetails;
