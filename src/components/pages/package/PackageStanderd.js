                            ...
                            <div className="row">
                                    ...
                                    <div className="package-card-xl">
                                        <div className="package-thumb-xl">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={pv_1} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                ...
                                <div className="col-lg-12 col-md-12">
                                    <div className="package-card-xl">
                                        <div className="package-thumb-xl">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={pv_2} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details-xl">
                                            <div className="package-info">
                                ...
                                <div className="col-lg-12 col-md-12">
                                    <div className="package-card-xl">
                                        <div className="package-thumb-xl">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={pv_3} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details-xl">
                                            <div className="package-info">
                                ...
                                <div className="col-lg-12 col-md-12">
                                    <div className="package-card-xl">
                                        <div className="package-thumb-xl">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={pv_4} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details-xl">
                                            <div className="package-info">
                                ...
                                <div className="col-lg-12 col-md-12">
                                    <div className="package-card-xl">
                                        <div className="package-thumb-xl">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={pv_5} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details-xl">
                                            <div className="package-info">
                                ...
                                <div className="col-lg-12 col-md-12">
                                    <div className="package-card-xl">
                                        <div className="package-thumb-xl">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={pv_7} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details-xl">
                                            <div className="package-info">
                                            ...
                                            <h3><i className="flaticon-arrival" />
                                                <Link to={"/package-details"}>Lake Geneva, Italy</Link>
                                            </h3>
                                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorem saepe amet magni!</p>
                                            <div className="package-rating">
                                ...
                                <div className="col-lg-12 col-md-12">
                                    <div className="package-card-xl">
                                        <div className="package-thumb-xl">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={pv_6} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details-xl">
                                            <div className="package-info">
