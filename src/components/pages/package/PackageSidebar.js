                            ...
                            <div className="row">
                                    ...
                                    <div className="package-card">
                                        <div className="package-thumb">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={p_1} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="package-card">
                                        <div className="package-thumb">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={p_2} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details">
                                            <div className="package-info">
                                            ...
                                            <h3><i className="flaticon-arrival" />
                                                <Link to={"/package-details"}>Lake Garda, Italy</Link>
                                            </h3>
                                            <div className="package-rating">
                                                <strong><i className="bx bxs-star" /><span>8K+</span> Rating</strong>
                                            </div>
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="package-card">
                                        <div className="package-thumb">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={p_3} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details">
                                            <div className="package-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="package-card">
                                        <div className="package-thumb">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={p_4} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details">
                                            <div className="package-info">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="package-card">
                                        <div className="package-thumb">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={p_5} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details">
                                            <div className="package-info">
                                            ...
                                            <h3><i className="flaticon-arrival" />
                                                <Link to={"/package-details"}>French Rivira, France</Link>
                                            </h3>
                                            <div className="package-rating">
                                                <strong><i className="bx bxs-star" /><span>8K+</span> Rating</strong>
                                            </div>
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6">
                                    <div className="package-card">
                                        <div className="package-thumb">
                                            <Link to={"/package-details"}>
                                                <img   loading="lazy" src={p_6} alt="" className="img-fluid" />
                                            </Link>
                                        </div>
                                        <div className="package-details">
                                            <div className="package-info">
