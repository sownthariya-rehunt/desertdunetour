...
import gallery1Img from "../../../assets/image_desert/new_pic/Half Day Desert Safari (1)/2.png";
import gallery2Img from "../../../assets/image_desert/new_pic/Half Day Desert Safari (1)/3.png";
import gallery4Img from "../../../assets/image_desert/new_pic/Morning desert safari (1)/1.png";
import gallery5Img from "../../../assets/image_desert/new_pic/Half Day Desert Safari (1)/4.png";
import gallery6Img from "../../../assets/image_desert/new_pic/Half Day Desert Safari (1)/5.png";
import SellIcon from '@mui/icons-material/Sell';
import galleryGxx1Img from "../../../assets/image_desert/new_pic/Half Day Desert Safari (1)/7.png";
...
class HalfDayDesertDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      startDate: new Date(),
                  ...
                  <div className="package-header">
                    <div className="package-title">
                      ...
                      <strong>
                        ...
                        <i> <b> Price <SellIcon/> - Adult : <span className="text-dark" >AED 305 ,</span> Child:  <span className="text-dark" >AED 210</span> (minimum 2
                        pax)</b></i>
                        </strong>
...
export default HalfDayDesertDetails;
