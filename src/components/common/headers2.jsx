...
//                                             <Link to={/} className="navbar-brand" onClick={this.scrollTop}><img   loading="lazy" src={logoMain} alt="" /></Link>
//                                         </div>
...
//                                             <img   loading="lazy" src={secondLogo} alt="" className="img-fluid" />
//                                         </div>
//                                         <ul>
...
//                                                     <li>
//                                                         <NavLink activeClassName="active" to={/} className="sub-item" onClick={this.scrollTop}>Home Page 1</NavLink>
//                                                     </li>
//                                                     <li>
...
//                                             </li>
//                                             <li>
//                                                 <NavLink activeClassName="active" to={/about-us} onClick={this.scrollTop}>About us</NavLink>
//                                             </li>
//                                             <li>
...
//                                                 <ul className="sub-menu">
//                                                     <li>
//                                                         <NavLink activeClassName="active" to={/package} className="sub-item" onClick={this.scrollTop}>package</NavLink>
//                                                     </li>
//                                                     <li>
//                                                         <NavLink activeClassName="active" to={/package-sidebar} className="sub-item" onClick={this.scrollTop}>package sidebar</NavLink>
//                                                     </li>
//                                                     <li>
//                                                         <NavLink activeClassName="active" to={/package-standard} className="sub-item" onClick={this.scrollTop}>package standard</NavLink>
//                                                     </li>
//                                                     <li>
//                                                         <NavLink activeClassName="active" to={/package-details} className="sub-item" onClick={this.scrollTop}>package details</NavLink>
//                                                     </li>
//                                                 </ul>
//                                             </li>
...
//                                             <li>
//                                                 <NavLink activeClassName="active" to={/contact} onClick={this.scrollTop} >Contact Us</NavLink>
//                                             </li>
//                                         </ul>
